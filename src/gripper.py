...
class Gripper:
    """
    Convenient Robotiq Gripper Interface

    This class provides convenience methods for the Robotiq gripper. It works by sending URScript code to open/close the
    gripper to the ur_driver/URScript ROS topic
    """
    def __init__(self, init_node=False):
        ...
        self.open_urscript = """
def gripper_open():
  modbus_add_signal("127.0.0.1", 255, 140, 3, "mbMnCommand", False)
  modbus_set_signal_update_frequency("mbMnCommand", 10)
  modbus_add_signal("127.0.0.1", 255, 141, 3, "mbMnCommandAck", False)
  modbus_set_signal_update_frequency("mbMnCommandAck", 10)
  modbus_add_signal("127.0.0.1", 255, 142, 3, "mbMnBoltNum", False)
  modbus_set_signal_update_frequency("mbMnBoltNum", 10)
  modbus_add_signal("127.0.0.1", 255, 143, 3, "mbMnTorque", False)
  modbus_set_signal_update_frequency("mbMnTorque", 10)
  modbus_add_signal("127.0.0.1", 255, 128, 3, "mbMaCommand", False)
  modbus_set_signal_update_frequency("mbMaCommand", 10)
  modbus_add_signal("127.0.0.1", 255, 129, 3, "mbMaCommandAck", False)
  modbus_set_signal_update_frequency("mbMaCommandAck", 10)
  modbus_add_signal("127.0.0.1", 255, 130, 3, "mbMaBoltNum", False)
  modbus_set_signal_update_frequency("mbMaBoltNum", 10)
  modbus_add_signal("127.0.0.1", 255, 131, 3, "mbMaTorque", False)
  modbus_set_signal_update_frequency("mbMaTorque", 10)
  modbus_set_runstate_dependent_choice("mbMnCommand",0)
  modbus_set_runstate_dependent_choice("mbMnCommandAck",0)
  modbus_set_runstate_dependent_choice("mbMnBoltNum",0)
  modbus_set_runstate_dependent_choice("mbMnTorque",0)
  modbus_set_runstate_dependent_choice("mbMaCommand",0)
  modbus_set_runstate_dependent_choice("mbMaCommandAck",0)
  modbus_set_runstate_dependent_choice("mbMaBoltNum",0)
  modbus_set_runstate_dependent_choice("mbMaTorque",0)
  set_gravity([0.0, 0.0, 9.82])
  set_safety_mode_transition_hardness(0)
  set_tcp(p[0.0,0.0,0.2921,0.0,0.0,0.0])
  set_payload(1.0,[0.0,0.0,0.02])
  ...
  global run_count=0
  global InitialTestPt=p[0.11088707739099124,-0.4664457082466442,-0.027949158690539544,1.153757927408179,-2.8124764149906514,0.0651876223307465]
  global VisionPoint_1=p[0.21422916820936672,-0.587395043425696,0.13917384664679822,-1.0904600109576406,2.6594097352328316,-0.712378005511048]
  # begin: URCap Installation Node
  #   Source: Robotiq_Wrist_Camera, 1.7.1, Robotiq Inc.
  #   Type: Camera
  ...
  VisionPoint_1 = p[0.158071, -0.397246, 0.453572, -1.11905, 2.59873, -0.725475]
  ...
  # begin: URCap Installation Node
  #   Source: Robotiq_Grippers, 1.5.1, Robotiq Inc.
  #   Type: Gripper
  ...
  # end: URCap Installation Node
  # begin: URCap Installation Node
  #   Source: YouRing, 2.1.2, Alumotion
  #   Type: YouRing
  uring = rpc_factory("xmlrpc","http://127.0.0.1:7937")
  # end: URCap Installation Node
  $ 1 "Robot Program"
...
"""
    ...
    def open(self):
        time.sleep(1)
        self.pub.publish(self.open_urscript)
        time.sleep(1)

    def close(self):
        time.sleep(1)
        self.pub.publish(self.close_urscript)
        time.sleep(1)
